...
class TestNakedTwins(unittest.TestCase):
    ...
    def test_naked_twins(self):
        #print('solution-1', sorted(self.possible_solutions_1, key=lambda x:sorted(x.keys())))# sorted(self.possible_solutions_1))
    ...
    def test_naked_twins2(self):
        #print('solution-2', sorted(self.possible_solutions_2, key=lambda x:sorted(x.keys())))#sorted(self.possible_solutions_2))   
        result = solution.naked_twins(self.before_naked_twins_2)
        #print('result', result)     
